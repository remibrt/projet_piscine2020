...
<body>
	<nav class="navbar navbar-expand-md">
		...
		<a class="navbar-brand" href="index.php">Ebay ECE</a>
		<img src="img/marteau.png" style="height: 30px;">
		<h1 class="navbar-brand" style="margin-left: 300px;">Enchères en Ligne</h1>
