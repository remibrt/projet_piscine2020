...
<?php require 'header.php';?>
		...
		<div class="fond">
			<div class="Info" style="margin-left: 30px;padding-top: 30px;">
				...
				<?php if(isset($_SESSION['panier']) && $_SESSION['panier'] != null){$ids = array_keys($_SESSION['panier']); $products = $conn->query('SELECT * FROM objets WHERE id IN ('.implode(',', $ids).')');?><tr><th>Produits : </th> <th>Description : </th><th>Prix : </th></tr><?php foreach ($products as $product):?>
					<tr>
